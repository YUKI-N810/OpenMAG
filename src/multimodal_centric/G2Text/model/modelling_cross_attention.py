...
class MPTConfig(PretrainedConfig):
    ...
    def __init__(self, cfg, opt_config, **kwargs):
        super().__init__(
        ...
        # MPT configuration
        self.neighbor_layer_wise = cfg.task.neighbor_layer_wise
        self.neighbor_mode = cfg.task.neighbor_mode
        self.peft_type = cfg.task.peft_type
        self.lora_r = cfg.task.lora_r
        self.lora_alpha = cfg.task.lora_alpha
        self.lora_dropout = cfg.task.lora_dropout
